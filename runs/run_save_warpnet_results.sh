...
# exp_31 bilinear
# exp_40 mask_1
# exp_42_l2 mask1 + mask2

python train_save_warpnet_results.py --cuda --train_img_dir "./DataSets/Original/Train" --train_landmark_dir "./DataSets/Original/Landmark" --train_sym_dir "./DataSets/Original/Sym_NM" --test_img_dir "./DataSets/Original/Test/testvgg" --test_landmark_dir "./DataSets/Original/Landmark" --test_sym_dir "./DataSets/Original/Sym_NM" --max_epoch 100 --exp_name "exp_42_swt_testvgg" --save_epoch_freq 20 --load_checkpoint "./checkpoints/exp_1/ckpt_040.pt" --load_checkpoint_B "./checkpoints/exp_30_cont/ckpt_100.pt" --load_checkpoint_C "./checkpoints/exp_31/ckpt_100.pt" --load_checkpoint_D "./checkpoints/exp_40/ckpt_080.pt" --load_checkpoint_E "./checkpoints/exp_42_l2_tot_loss/ckpt_100.pt"
