...
from custom_criterions import MaskedMSELoss, TVLoss, SymLoss, FullSymLoss, BilinearFullSymLoss, MaskedBilinearFullSymLoss
import random
from os import path
...
class Runner(object):
    ...
    def prepare_data(self):
        ...
        self.train_dataset = dataset.FaceDataset(opt.train_img_dir, opt.train_landmark_dir, opt.train_sym_dir, opt.train_mask_dir, opt.flip_prob, train_tsfm_c, False)
        ...
        self.test_dataset = dataset.FaceDataset(opt.test_img_dir, opt.test_landmark_dir, opt.test_sym_dir, opt.test_mask_dir, -1, test_tsfm_c, True)
