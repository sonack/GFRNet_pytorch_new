...
# python train_wgan_validator_clean.py --cuda --train_img_dir "./DataSets/Original/Train" --train_landmark_dir "./DataSets/Original/Landmark" --test_img_dir "./DataSets/Original/Test/testvgg" --test_landmark_dir "./DataSets/Original/Landmark" --max_epoch 200 --exp_name "wgan_mnist_WGAN-GP_final" --print_freq 100 --disp_freq 100 --save_epoch_freq 50 --pd_L_l_w 2 --pd_R_l_w 2 --pd_N_l_w 2 --pd_M_l_w 2 --gd_l_w 1 --ld_l_w 0.5 --lr_l_w 1 --perp_l_w 0 --kind "weaker_1" --GD_cond 6 --PD_cond 6 --parts_expand 1.2 --lr 1e-4 --use_WGAN_GP --batch_size 50
# --disp_img_cnt 8
# --load_warpnet "./checkpoints/exp_1/ckpt_040.pt"


python train_wgan_validator_clean.py --cuda --train_img_dir "./DataSets/Original/Train" --train_landmark_dir "./DataSets/Original/Landmark" --test_img_dir "./DataSets/Original/Test/testvgg" --test_landmark_dir "./DataSets/Original/Landmark" --max_epoch 200 --exp_name "wgan_cifar10_WGAN-GP_final" --print_freq 100 --disp_freq 100 --save_epoch_freq 50 --pd_L_l_w 2 --pd_R_l_w 2 --pd_N_l_w 2 --pd_M_l_w 2 --gd_l_w 1 --ld_l_w 0.5 --lr_l_w 1 --perp_l_w 0 --kind "weaker_1" --GD_cond 6 --PD_cond 6 --parts_expand 1.2 --lr 1e-4 --use_WGAN_GP --batch_size 64
