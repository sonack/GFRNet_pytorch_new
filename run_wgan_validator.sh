...
python train_wgan_validator.py --cuda --train_img_dir "./DataSets/Original/Train" --train_landmark_dir "./DataSets/Original/Landmark" --test_img_dir "./DataSets/Original/Test/testvgg" --test_landmark_dir "./DataSets/Original/Landmark" --max_epoch 1500 --exp_name "wgan_mnist" --print_freq 10 --disp_freq 10 --save_epoch_freq 1 --pd_L_l_w 2 --pd_R_l_w 2 --pd_N_l_w 2 --pd_M_l_w 2 --gd_l_w 1 --ld_l_w 0.5 --lr_l_w 1 --perp_l_w 0 --kind "weaker_1" --GD_cond 6 --PD_cond 6 --parts_expand 1.2  --load_warpnet "./checkpoints/exp_1/ckpt_040.pt" --lr 2e-5 --use_WGAN_GP